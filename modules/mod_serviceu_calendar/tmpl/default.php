...
<form action="<?php echo JRoute::_('index.php?option=com_serviceu&view=eventlist'.($activemenu?('&Itemid='.$activemenu->id):'')) ?>" method="get" id="event_calendar_date_picker">
	...
	<input type="hidden" name="rsevents_calendar_module_itemid" value="<?php echo $activemenu?$activemenu->id:'' ?>" id="rsevents_calendar_module_itemid" />
</form>